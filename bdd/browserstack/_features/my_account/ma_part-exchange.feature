@my_account @ma_px
Feature: My Account PX (part-exchange) page
  In order to be able check my offers or sell my car
  As a User
  I would like to have MA PX page

  Scenario: Check the user can land on the PX page.
    ...
    And I should see element with xpath "//h1[text()='My Account']"
    When I am on a "account/part-exchange" page
    And I wait a maximum of "8000" ms
    Then I should see element with xpath "//h1[text()='Your Current Cars']"
